...
void set_default_settings(Settings *settings)
{
	...
	settings->setDefault("keymap_inventory", "KEY_KEY_Q");
	settings->setDefault("keymap_examine", "KEY_KEY_F");
	settings->setDefault("keymap_use", "KEY_KEY_F");
	settings->setDefault("keymap_chat", "KEY_KEY_T");
	settings->setDefault("keymap_cmd", "/");
	settings->setDefault("keymap_rangeselect", "KEY_KEY_O");
	settings->setDefault("keymap_freemove", "KEY_LCONTROL");
	settings->setDefault("keymap_up", "KEY_SPACE");
	settings->setDefault("keymap_down", "KEY_KEY_R");
